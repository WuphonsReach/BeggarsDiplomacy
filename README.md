...
- The stolen grain quest (qst_deliver_grain) will also be offered again faster than before (5-20 days instead of 20 days).  It rewards +2 reputation when you accept and 4-6 upon completion (depending on number of bags of grain).  Village prosperity is increased by 2 plus 1/4 the number of bags.
