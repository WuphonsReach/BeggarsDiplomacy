...
- The peasant training quest ().  Each round of training the peasants (train_peasants_against_bandits) now takes about half as much game-time before pitting you against the peasants (~3 hours at Training skill of 10).  Losing the mock training battle round now counts towards quest completion.  That makes the quest less frustrating for players.
