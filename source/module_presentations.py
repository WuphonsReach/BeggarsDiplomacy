                ...
                (try_begin), # not same faction
                  ...
                  (try_begin),
                      ...
                      (else_try), # Truce (non aggression)
                          ...
                          (try_begin),
                              (gt, ":extended_diplomatic_status", dplmc_treaty_defense_days_initial),
                              (str_store_string, s60, "@Alliance"),
                              (assign, reg60, 0x00FF00),
                              (store_sub, reg59, ":extended_diplomatic_status", dplmc_treaty_defense_days_initial),
                          (else_try),
                              (gt, ":extended_diplomatic_status", dplmc_treaty_trade_days_initial),
                              (str_store_string, s60, "@Defense"),
                              (assign, reg60, 0x00FFAA),
                              (store_sub, reg59, ":extended_diplomatic_status", dplmc_treaty_trade_days_initial),
                          (else_try),
                              (gt, ":extended_diplomatic_status", dplmc_treaty_truce_days_initial),
                              (str_store_string, s60, "@Trade"),
                              (assign, reg60, 0x00FFCC),
                              (store_sub, reg59, ":extended_diplomatic_status", dplmc_treaty_truce_days_initial),
                          (try_end),
                      (try_end),
